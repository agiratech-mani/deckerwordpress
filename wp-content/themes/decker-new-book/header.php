					...
					<div class="col-sm-8">
						<center>
							<div id="video-cti" class="center-block">
                                <iframe id="play-cti" width="100%" height="339px" src="https://www.youtube.com/embed/L9cG3bHu9eo?theme=light&hd=1&rel=0&modestbranding=1&showinfo=0" frameborder="0" allowfullscreen></iframe>
								<!--<iframe id="play-cti" width="100%" height="339px" src="https://www.youtube.com/embed/videoseries?listType=playlist&list=PLvCNoKguFjZ2HMMJFu006WLwxyxLAKugp&theme=light&hd=1&rel=0&modestbranding=1&showinfo=0&loop=0" frameborder="0" allowfullscreen></iframe>-->
							...
							<ul id="book_btns">
								...
								<li><a href="https://itunes.apple.com/us/book/communicate-to-influence-how/id965955044?mt=11" target="_blank"><img src="/wp-content/themes/decker-new-book/images/jtron_btn3.png" alt="ibookstore button"/></a></li>
							</ul>
						</center>
					</div>
				</div>
