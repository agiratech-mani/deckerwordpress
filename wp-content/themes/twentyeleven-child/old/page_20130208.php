				        ...
				        <div id="home-block">
				            ...
				            <div id="home-solution-matching">
                                ...
                                <div class="solution-match bottom">
                                    ...
                                    <p class="match end">
                                        <a href="/training-formats-programs/solution-matching-tool/"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-tool.png" width="228" height="127" alt="Best Training, Class, Workshop, Coaching, Communications, Messaging, Storytelling, Presentation, Public Speaking, Corporate, Speaking, Training, Kickoff, Keynote, Solution" title="Best Training, Class, Workshop, Coaching, Communications, Messaging, Storytelling, Presentation, Public Speaking, Corporate, Speaking, Training, Kickoff, Keynote, Solution" /></a>
                                    </p>
                                </div>
				            </div>
				        </div>
				        ...
				        if($post->ID==115){
				            ...
				            <div id="programs">
                                ...
                                <div class="middle three-across">
                                    <div class="cell match full">
                                        ...
                                        <p>'.get_post_meta($post->ID, 'match_text', true).'&nbsp;
                                        <img src="/wp-content/themes/twentyeleven-child/images/arrow-white-on-green.png" width="8" height="9" alt="Communications Solutions" title="Communications Solutions" /></p>
                                        </a>
                                    </div>
                                </div>
                                <p class="bottom"></p>
				            ...
				            <div id="programs">
                                ...
                                <div class="middle three-across">
                                    ...
                                    <div class="cell match">
                                        <a href="/training-formats-programs/solution-matching-tool/">
                                        <img class="title-image" src="/wp-content/themes/twentyeleven-child/images/programs-still-not-sure.png" width="134" height="68" title="Communication Solutions" alt="Communication Solutions" /><br />
                                        <p>'.get_post_meta($post->ID, 'match_text', true).'
                                        <img src="/wp-content/themes/twentyeleven-child/images/arrow-white-on-green.png" width="8" height="9" alt="." /></p>
                                        </a>
                                    </div>
