				            ...
				            <div id="home-solution-matching">
				                <div class="solution-match top">
                                    <p class="match" id="match-open">
                                        <a href="#home-solution-matching"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-open.png" width="229" height="127" alt="Open Enrollment" /></a>
                                    </p>
                                    <p class="match" id="match-group">
                                        <a href="#home-solution-matching"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-group.png" width="229" height="127" alt="Group Training" /></a>
                                    </p>
                                    <p class="match end" id="match-coaching">
                                        <a href="#home-solution-matching"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-coaching.png" width="228" height="127" alt="Executive Coaching" /></a>
                                    </p>
                                </div>
                                <div class="solution-match bottom">
                                    <p class="match" id="match-keynote">
                                        <a href="#home-solution-matching"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-keynotes.png" width="229" height="127" alt="Keynotes and Events" /></a>
                                    </p>
                                    <p class="match" id="match-customization">
                                        <a href="#home-solution-matching"><img src="/wp-content/themes/twentyeleven-child/images/solution-matching-customization.png" width="229" height="127" alt="Program Customization" /></a>
                                    </p>
                                    <p class="match end">
