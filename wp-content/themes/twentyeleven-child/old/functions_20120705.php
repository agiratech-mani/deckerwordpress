...
function call_to_action($attr) {
    ...
    if($attr['class']=='ac'){
        $cta_schedule = '
            <a href="'.$otherlink.'">
            <p class="title '.$attr['class'].'">Schedule coaching for<br />your big presentation '.$arrow.'</p>
            <p>'.$otherword.'</p>
            </a>';
        $cta_download = '
            <a href="'.$attr['pdflink'].'" target="_blank">
            <p class="title '.$attr['class'].'">Download the coaching overview '.$arrow.'</p>
            <p>Get a printer-friendly PDF</p>
            </a>';
    } else {
        $cta_schedule = '
            <a href="'.$otherlink.'">
