...
if($_SERVER['SCRIPT_URL']=='/shop/'){//shop
    header("Location: http://decker.com/continuous-learning/self-directed-learning-resources/");
    exit;
} elseif(is_single() && in_category(1531)){//press post
    header("Location: http://decker.com/about-us/press/");
    exit;
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			<div id="hgroup">
				<div id="header-left">
				    <a href="/"><img src="/wp-content/themes/twentyeleven-child/images/logo.png" width="462" height="51" alt="Decker Communications" /></a>
				</div>
				<div id="header-right">
                    <p class="top-menu-icons">
                        <a href="/feed/" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/icon-rss.png" width="42" height="17" alt="Decker Communications Blog RSS" title="Decker Communications Blog RSS" /></a>
                        ...
                        <a href="https://plus.google.com/104849810366927097644/posts" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/icon-google-plus.png" width="17" height="17" alt="Decker Communications on Google Plus" title="Decker Communications on Google Plus" /></a>
