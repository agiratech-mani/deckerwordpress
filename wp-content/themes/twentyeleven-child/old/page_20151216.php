				            ...
				            <div class="home-register">
                                ...
                                /*
                                        ...
                                        <div class="aside-bottom text-11"></div>';
                                                                      */
//                                if ($_SERVER['REMOTE_ADDR'] == "81.56.223.186" || $_SERVER['REMOTE_ADDR'] == "68.230.24.243")   {
                                if ( $_GET['test']=1 ) {
/*
                                        echo '
                                        <style type="text/css">.gform_wrapper {margin:0 !important;}#home-right #text-text-11 .textwidget a {display:none;}</style>
                                        ...
                                        <aside id="text-text-11" class="widget widget_text">
                                            <div class="textwidget">
                                                <img src="https://decker.com/wp-content/uploads/2015/12/2015-communicators-with-title.jpg" />
                                                Our 20th annual list shows how communications helped make or break notables from business, politics, sports and entertainment.
                                                <a href="https://decker.com/blog/the-top-ten-best-and-worst-communicators-of-2015/" style="display: inline !important;">See the list</a>
                                            </div>
                                        </aside>
                                        <div class="aside-bottom text-11"></div>';
                                        */
