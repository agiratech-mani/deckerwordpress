...
//                                echo do_shortcode('[portfolio_slideshow id=8341 target=current]');
                            ...
                            <?php
	       	                    if(is_front_page()){
	       	                        if($_GET['test']==1){
	       	                            echo '
                                        <div class="banner-usatoday" style="padding-top:14px;"><img src="/wp-content/themes/twentyeleven-child/images/USA-today-orange.jpg" alt="as seen in USA Today" /> </div>
                                    ';
				            ...
				            <?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
	       	                    ...
	       	                    if(is_front_page()){
	       	                        if($_GET['test']==1){
                                        ...
                                        <style type="text/css">.deckergrid {padding-left:2% !important;} #home-right #text-text-3 .textwidget {height: 428px;}</style>
                                        <div class="deckergrid" style="padding-top:19px;"><a href="https://decker.com/wp-content/uploads/2015/08/The_Decker_Grid.pdf" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/Downloadbutton.jpg" alt="Download The Decker Grid" /></a> </div>
                                    ';
				...
				<?php endwhile; // end of the loop. ?>
                      ...
                      <?php
	       	                    if(is_front_page()){
	       	                        echo '
                                    &nbsp;
                                    <div id="homefeatured"> <h2 style="text-align: none ;"> &nbsp; &nbsp; &nbsp; Featured in:</h2>
                                    <center>
                                    <table class="wide featured-in" style="padding: 0 0 2em 0;">
                                    <tbody>
                                    <tr>
                                    <td style="text-align: center;">
                                    <a title="Featured Press" href="/about-us/press/">
                                    <img class="size-full wp-image-10084 alignnone alignleft" alt="sstn-wsj"
                                    src="/wp-content/uploads/2014/09/sstn-wsj.jpg" width="235"
                                    height="49" /></a>&nbsp;<a href="about-us/press/"><img class="size-full
                                    wp-image-10085 alignnone alignleft" alt="sstn-forbes" src="/wp-content/uploads/2014/09/sstn-forbes.jpg"
                                    width="139" height="50" /></a><a href="/about-us/press/"><img class="alignleft size-full wp-image-10086
                                    alignleft" alt="sstn-usa-today" src="/wp-content/uploads/2014/09/sstn-usa-today.jpg" width="138" height="50" />
                                    </a><a href="/about-us/press/"><br/><center><img class="alignnone  wp-image-10087 alignleft" alt="sstn-investors"
                                    src="/wp-content/uploads/2014/11/sstn-ny-3.png" width="274" height="50" /> <a href="/about-us/press/"><img class="alignnone  wp-image-10087 alignleft" alt="sstn-investors"
                                    src="/wp-content/uploads/2014/09/sstn-investors.jpg" width="185" height="50" /> </center>
                                    </a></td></tr>
                                    </tbody>
                                    </table></center> </div>';}
                     ?>  -->
