...
if(is_page_template( 'page-landing-page.php' )){
    include_once "sidebar-landing.php";

} elseif(wpmd_is_phone() || $_REQUEST['phone']==1){
    //get_sidebar();

} elseif(!is_front_page() && !is_page_template( 'page-left-sidebar-only.php' )
  && !is_page_template( 'page-press.php' ) && !is_page_template( 'page-full-width.php')
  && !is_page_template( 'page-full-width-blocks.php') && !is_page_template( 'page-full-width-layouts.php')){
    get_sidebar();
}
	   ...
	   <!--
        ...
        <div id="footer-bottom">
	        ...
	        <div class="footer-menu" id="footer-left">
		        ...
		        <a href="http://m.feedblitz.com/decker" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/icon-rss-grey.png" width="42" height="20" alt="Decker Communications Blog RSS" title="Decker Communications Blog RSS" /></a>
                ...
                <a href="https://plus.google.com/104849810366927097644/posts" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/icon-google-plus-grey.png" width="17" height="20" alt="Decker Communications on Google Plus" title="Decker Communications on Google Plus" /></a>
...
.page-template-page-full-width-php #video-cti,
.page-template-page-full-width-php #video-dmtsm,
.page-template-page-full-width-php #video-next,
.page-template-page-full-width-php #video-exec,
.page-template-page-full-width-layouts-php #video-digital {
    left:0;
}
#video-cti p,
#video-dmtsm p,
...
#video-cti .video-overlay {
    background-image:url(https://decker.com/wp-content/uploads/2014/09/video-overlay-hilary3.png);
}
#video-dmtsm .video-overlay {
    background-image:url(https://decker.com/wp-content/uploads/2014/09/video-overlay-bruce.png);
}
#video-next .video-overlay {
    background-image:url(https://decker.com/wp-content/uploads/2014/09/video-overlay-amelia.png);
}
#video-exec .video-overlay {
    background-image:url(https://decker.com/wp-content/uploads/2012/06/video-overlay-keith2.png);
}
#video-digital .video-overlay {
    background-image:url(https://decker.com/wp-content/uploads/2016/08/promo-video.png);
    background-size:905px 487px;
    top:9px;
    width:905px;
    height:487px;
    margin:0 auto;
...
<script type="text/javascript">
    ...
    $("#video-exec").on("click",function(){
        $('#video-exec .video-overlay').fadeOut(2000);
        $("#play-exec")[0].src += "&autoplay=1";
        ev.preventDefault();
    });
    $("#video-digital").on("click",function(){
        $('#video-digital .video-overlay').fadeOut(2000);
        $("#play-digital")[0].src += "&autoplay=1";
        ev.preventDefault();
    });
</script>

<script type='text/javascript' src='/wp-content/themes/twentyeleven-child/js/functions.js'></script>
</body>
</html>