...
if($_SERVER['SCRIPT_URL']=='/shop/'){//shop
    ...
    header("Location: /");
    exit;
} elseif (is_product(14079)){
    header("HTTP/1.1 301 Moved Permanently");
    header("Location: ".get_permalink(13498)); // Decker Digital
}
/**
...
<?php
if(!is_front_page() && $post->ID!=13775 && !is_page_template( 'page-landing-page.php' ) && (wpmd_is_notphone() && $_REQUEST['phone']!=1)
