      ...
      if(!is_page_template( 'page-landing-page.php' )){
		...
		if($post->ID==20){//about us
		    ...
		    <div class="widgets simple video">
                '.do_shortcode('[wp_lightbox_flowplayer_video link="/wp-content/uploads/2012/06/flashvideo_decker.flv" source="/wp-content/uploads/2012/06/img_video_deckers.jpg" img_attributes="alt=\'image description\'"]').'
        ...
        //'.do_shortcode('[wp_lightbox_flowplayer_video link="/wp-content/uploads/2012/07/flashvideo_brusseau.flv" source="/wp-content/uploads/2012/07/img_video_blue_brusseau.jpg" img_attributes="alt=\'Transforming Communications at Stryker\'"]').'
		    echo '
		    <div class="widgets simple video">
                '.do_shortcode('[wp_lightbox_prettyPhoto_video link="http://www.youtube.com/watch?v=-rvb135CmvI&amp;modestbranding&amp;amp;showinfo=0&amp;amp;theme=light&amp;amp;rel=0" description="Rick Osgood describes the Decker record and legacy" source="/wp-content/uploads/2012/07/img_video_blue_osgood.jpg" title="Rick Osgood describes the Decker record and legacy"]').'
                <div class="textwidget">
            ...
            <div class="widgets simple video">
                    '.do_shortcode('[wp_lightbox_prettyPhoto_video link="http://www.youtube.com/watch?v=mjts35JNDDk&amp;modestbranding&amp;amp;showinfo=0&amp;amp;theme=light&amp;amp;rel=0" description="Transforming Communications at Stryker" source="/wp-content/uploads/2012/07/img_video_blue_brusseau.jpg" title="Transforming Communications at Stryker"]').'
                <div class="textwidget">
		    ...
		    echo '
		    <div class="widgets simple video">
                '.do_shortcode('[wp_lightbox_flowplayer_video link="/wp-content/uploads/2012/07/flashvideo_3x3.flv" source="/wp-content/uploads/2012/07/img_video_blue_bert.jpg" img_attributes="alt=\'Coaching, Consulting and Feedback\'"]').'
                <div class="textwidget">
		    ...
		    echo '
		    <div class="widgets simple video">
                '.do_shortcode('[wp_lightbox_flowplayer_video link="/wp-content/uploads/2012/06/flashvideo_keim.flv" source="/wp-content/uploads/2012/07/img_video_blue_keim.jpg" img_attributes="alt=\'Improving Corporate Presentations\'"]').'
                <div class="textwidget">
		    ...
		    echo '
		    <div class="widgets simple video">
                '.do_shortcode('[wp_lightbox_flowplayer_video link="/wp-content/uploads/2012/07/flashvideo_nelson.flv" source="/wp-content/uploads/2012/07/img_video_blue_nelson.jpg" img_attributes="alt=\'What is Unique about Decker Communications\'"]').'
                <div class="textwidget">
