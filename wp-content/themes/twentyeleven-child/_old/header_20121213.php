...
//if(stripos($_SERVER['SCRIPT_URI'],'/blog/')!==false || !is_page()){
if((!is_front_page() && !is_page() && get_post_type($post->ID)!='product') || $post->ID==115){ // blog
    $profile = 'UA-10972048-1';
} else {
    $profile = 'UA-3456084-3';
}
?>

<script type="text/javascript">
   var _gaq = _gaq || [];
  _gaq.push(['_setAccount', '<?php echo $profile;?>']);
			...
			<div id="hgroup">
				...
				<div id="header-right">
                    <p class="top-menu-icons">
                        ...
                        <a href="http://www.youtube.com/user/DeckerComm" target="_blank"><img src="/wp-content/themes/twentyeleven-child/images/icon-youtube.png" width="47" height="20" id="youtube" alt="YouTube" /></a>
                    </p>
