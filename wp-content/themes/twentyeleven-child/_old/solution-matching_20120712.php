...
<form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" id="contactform">
    ...
    <input type=hidden name="retURL" value="http://decker.com.s149383.gridserver.com/thank-you/">
    <!--  ----------------------------------------------------------------------  -->
    ...
    <p><label>This training is for:</label><br />
        <input type="text" id="choice-q1-desc" name="q1" size="36" value="" readonly /><br />
        <input type="text" id="choice-q2-desc" name="q2" size="36" value="" readonly /><br />
    ...
    <input id="00N50000002e11u" maxlength="60" name="00N50000002e11u" size="36" type="text" class="required" /></p>

    <p><input type="submit" value="Send Message" name="submit" class="button" id="submit" /></p>
</form>';

//$salesforce_form = do_shortcode('[gravityform id=7 title=false description=false]');
?>
    ...
    <div id="individual-block">
        ...
        <div class="q5 individual results">
            ...
            <div class="individual middle">
                <p class="result" id="individual-cti">The program that best matches your needs is CTI
                    <br /><a href="/training-formats-programs/open-classes/communicate-to-influence/">Learn More ></a>
                    <br /><a href="/training-formats-programs/program-registration/">Register Now ></a></p>
                <p class="result" id="individual-dmtsm">The program that best matches your needs is DMTSM
                    <br /><a href="/training-formats-programs/open-classes/decker-made-to-stick-messaging/">Learn More ></a>
                    <br /><a href="/training-formats-programs/program-registration/">Register Now ></a></p>
                <!--<p class="result" id="individual-consult">Submit your contact details and someone will contact you about your event.</p>-->
                <p class="result" id="individual-consult">Platinum wording....</p>
        ...
        <div class="q5 group results">
            ...
            <div class="group middle">
                <p class="result" id="group-cti">The program that best matches your needs is <span class="highlight">Decker Communicate to Influence&trade;</span>.
                    <br /><a href="/training-formats-programs/corporate-training-solutions/group-training/communicate-to-influence/">Learn More ></a>
                    <br /><a href="/training-formats-programs/program-registration/">Register Now ></a>
                </p>
                <p class="result" id="group-dmtsm">The program that best matches your needs is DMTSM.
                    <br /><a href="/training-formats-programs/corporate-training-solutions/group-training/decker-made-to-stick-messaging/">Learn More ></a>
                    <br /><a href="/training-formats-programs/program-registration/">Register Now ></a></p></p>
