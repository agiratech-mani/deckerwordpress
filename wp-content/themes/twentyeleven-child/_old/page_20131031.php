...
if(is_page_template( 'page-left-sidebar-only.php' ) || is_page_template( 'page-landing-page.php' ) ){//locations page
		...
		<div id="primary" <?php echo $template_class;?>>
			<div id="content" role="main">
				...
				<?php while ( have_posts() ) : the_post(); ?>
				    ...
				    if(is_front_page()){?>
				        <div id="home-block">
				            <?php echo do_shortcode('[portfolio_slideshow id=8341 target=current]');
				        ...
				        <div id="home-right">
				            ...
				            <div class="home-register">
				                <?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
	       	                    ...
	       	                    <?php
	       	                    if(is_front_page()){?>
                                <div class="aside-top text-8" style="margin:8px 0 0 0;"></div>
                                    <aside id="text-text-8" class="widget widget_text">
                                        <a href="http://www.usatoday.com/story/money/columnist/edmunds/2013/02/05/edmunds-presentations/1893701/" target="_blank" style="line-height:1em;display:block;"><img src="/wp-content/uploads/2013/02/USA_Today_Feb.png" width="231" height="254" alt="Decker Communications USA Today Money" title="Decker Communications USA Today Money" /></a>
                                    </aside>
                                <div class="aside-bottom text-8"></div>
                                    <?php
                                }?>
		                    </div>
