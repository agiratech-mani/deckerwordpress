...
function sidebar_styling($params){
    if($params[0]['widget_id']=='text-3'){
        $params[0]['before_widget'] = '<div class="aside-top"></div><aside id="text-'.@$params[0]['widget_id'].'" class="widget widget_text">';
        $params[0]['after_widget'] = '</aside><div class="aside-bottom"></div>';
    }
    return $params;
}
