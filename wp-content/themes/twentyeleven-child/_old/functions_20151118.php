...
function ja_search_filter( $query ) {
    ...
    if (($query->is_search && !is_admin()) || ($query->is_feed && !$query->query['category_name'])){
        ...
        // Attempting to use the wp-combine-queries plugin
        // $args1 = [
        //     'post_type' => 'post',
        //     'category__not_in' => array(1531),
        // ];
        // $args2 = [
        //     'post_type' => 'page',
        //     'post__in' => array('10908', '12570', '12566', '12572', '266', '180'),
        // ];
        ...
        // $query->set( 'combined_query', $args['combined_query'] );
