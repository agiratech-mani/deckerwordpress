...
class WC_Shipping_Fedex_Init {
	...
	public function upgrade_notice() {
		...
		<div class="notice notice-success is-dismissible wc-fedex-notice">
			<p><?php echo sprintf( __( 'FedEx now supports shipping zones. The zone settings were added to a new FedEx method on the "Rest of the World" Zone. See the zones %shere%s ', 'woocommerce-shipping-fedex' ),'<a href="' .$zones_admin_url. '">','</a>' ); ?></p>
		</div>
